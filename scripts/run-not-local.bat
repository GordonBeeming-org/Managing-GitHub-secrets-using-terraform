cd ..
terraform init -var-file="envs/test.tfvars" -backend-config="envs/test.tfbackend" %*
terraform plan -input=false -var-file="envs/test.tfvars" -out="envs/test.tfplan" %*
terraform apply -auto-approve %* "envs/test.tfplan"

terraform init -var-file="envs/production.tfvars" -backend-config="envs/production.tfbackend" %*
